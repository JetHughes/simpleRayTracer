...
public:
	 ...
	 * extension. 
	 *
	 * \todo Update code in order to support super-sampling for anti-aliasing.
	 * 
...
private:
	 ...
	 * returned.
	 *
	 * \todo Implement diffuse and specular lighting
	 * \todo mplement Shadows and mirror reflection
	 * 
	 * Currently this method only deals with ambient lighting and Material properties.
